...
'''
In this exercise we will write a script that identified gene promoters that are bound by 2 factors
...
run week3_exercise3.py [TSS_GFF_FILE] [REGION1_BED_FILE] [REGION2_BED_FILE] [OUTPUT_FILE]

For example:

run week3_exercise3.py MM9_TSS_CHR6_-5000_+5000.gff MES_H3K4ME3_chr6_peaks.bed MES_H3K27ME3_chr6_peaks.bed chr6bivalent_genes.txt
'''

#modify your week3_exercise2.py script to check for overlap of two different factors
